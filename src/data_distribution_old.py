...
def app():
    ...
    with st.container():
        ...
        st.header("Geografische PKW-Messstationen und Fahrrad-Zählstellen auf der Karte mit ihren jeweiligen Zählwerten")
    ...
    #with st.container():
        ...
        col1, col2,col3 = st.columns([7,1,7])  # Equal width; adjust ratios if needed
